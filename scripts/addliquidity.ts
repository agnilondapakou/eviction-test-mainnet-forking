...
const main = async () => {
    ...
    console.log('-------------------------- Adding liquidity in the pool --------------------------')
    ...
    console.log('-------------------------- liquidity added in the pool --------------------------')
    ...
    console.log('impersonneted account usdc bal AF:', ethers.formatUnits(usdcBalAfter, 6))

    console.log('impersonneted account dai bal AF:', ethers.formatUnits(daiBalAfter, 18))
